 ...
 * $tb_title  - it is used to hidden title
 */
	...
	<?php print render($title_prefix); ?>
		<?php if ($block->subject): ?>
			<?php if($block->region=='content'): ?>
				<h1 class="subject <?php print $class_suffix; ?>"<?php print $title_attributes; ?>>
					<?php echo $block->subject; ?>
				</h1>
			<?php else: ?>
				<h2 class="subject <?php print $class_suffix; ?>"<?php print $title_attributes; ?>>
					<?php echo $block->subject; ?>
				</h2>
			<?php endif; ?>
		<?php endif; ?>
